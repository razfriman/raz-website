...
type TeslaProps = React.ComponentPropsWithoutRef<"svg"> & {
  /**
...
const Tesla: IconType = React.forwardRef<SVGSVGElement, TeslaProps>(
  function Tesla(
    { title = "Tesla", color = "currentColor", size = 24, ...others },
    ref,
  ) {
    if (color === "default") {
      color = defaultColor;
...
export { Tesla as default, defaultColor };
